...
results_file = open("attempt_#41-October25_2020-Fixed anchors.txt", "r")
# results_file = open("attempt_#32-October17_2020.txt", "r")
...
# ########################## REFERENCE PART####################################
# results_file = open("attempt_#42-October26_2020-Train-on-Cornell - Jacquard-weights.txt", "r")
# epochs = results_file.read().splitlines()
# epochs = np.array(epochs)
#
# losses = []
...
# ax1.plot(epoch_numbers, val_grasp_losses, label='Reference')
# ##############################################################
