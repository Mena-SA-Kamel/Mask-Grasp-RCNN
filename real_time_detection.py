...
MODEL_DIR = "models"
model_path = os.path.join(MODEL_DIR, "mask_rcnn_object_vs_background_WISDOM-50_head_50_all.h5")
...
try:
    while True:
        ...
        r = results[0]
        masked_image = get_mask_overlay(rgbd_image[:,:,0:3], r['masks'], r['scores'], threshold=0.85)
